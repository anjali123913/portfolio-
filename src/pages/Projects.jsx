...
const projects = [
  // Live Projects
  {
    ...
    items: [
      {
        name: "MyPatrakar",
        desc: "Journalist platform to create personal websites & apps",
        live: "https://mypatrakar.com",
        github: "",
      },
      {
        name: "LinkedSkillInstitute",
        desc: "Institute portal with courses & student management",
        live: "https://linkedskillitinstitute.com",
        github: "",
      },
      {
        name: "ProductWare",
  ...
  // Personal / Non-Live Projects
  {
    ...
    items: [
      {
        name: "Dual AI",
        desc: "AI Chatbot + Image Generator powered by Gemini API",
        github: "https://github.com/yourusername/dual-ai",
        live: "",
      },
      {
        name: "BuyBuddy",
